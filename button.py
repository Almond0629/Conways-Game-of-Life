...
class Button:
    def __init__(self, x, y, content: str, fontsize, color=col_background, align_left=False):
    ...
    def update(self, content):
        self = self.__init__(self.x, self.y, content, self.fontsize, align_left=self.align_left)